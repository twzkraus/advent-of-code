...
//     const vector = directionVectors[direction].map((num) => num * parseInt(val));
//     position = [position[0] + vector[0], position[1] + vector[1]]
//   }
// });

// console.log(position);
// console.log('part 1 answer is', position[0] * position[1])
...
// down 8
// forward 2`;
// const instructionsTest = testInput.split('\n');
// let positionTest = [0, 0, 0];
// instructionsTest.forEach((ins) => {
//   const [direction, val] = ins.split(' ');
//   if (direction) {
//     positionTest = getNewPosition(positionTest, direction, parseInt(val))
//     console.log({positionTest})
//   }
// });

// console.log(positionTest);
// console.log('part 2 answer is', positionTest[0] * positionTest[1])
